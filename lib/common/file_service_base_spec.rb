...
context "A FileInfo with chunk_size=1" do
  setup do
    @fi=FileInfo.new
    @fi.file_size=5
...
context "A FileInfo with chunk_size=256 and file_size=768" do
  setup do
    @fi=FileInfo.new
...
context "A FileInfo with chunk_size=256 and file_size=255" do
  setup do
    @fi=FileInfo.new
    @fi.base_chunk_size=256
    @fi.file_size=255
