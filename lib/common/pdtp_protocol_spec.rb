...
describe "PDTPProtocol validate_message" do
  it "optional params work" do
    ...
    proc { PDTPProtocol.validate_message(msg1)}.should_not raise_error
    proc { PDTPProtocol.validate_message(msg2)}.should_not raise_error
    proc { PDTPProtocol.validate_message(msg3)}.should raise_error
  end
  ...
  it "required params work" do
    ...
    proc { PDTPProtocol.validate_message(msg1)}.should raise_error
    proc { PDTPProtocol.validate_message(msg2)}.should_not raise_error
    proc { PDTPProtocol.validate_message(msg3)}.should raise_error
  end
