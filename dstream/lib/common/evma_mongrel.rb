# evma_mongrel.rb - Mongrel for EventMachine
# (C)2007 Kirk Haines.  All Rights Reserved.
# Distributed under the terms of the GNU General Public License.  See file COPYING for details
    ...
    def receive_data data
      ...
      if @parser.finished?
        if @request_len.nil?
          ...
          path_info, script_name, handlers = ::Mongrel::HttpServer::Instance.classifier.resolve(@params[::Mongrel::Const::REQUEST_PATH])
          if handlers
